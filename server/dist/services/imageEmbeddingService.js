...
exports.cosineSimilarity = exports.getImageEmbedding = void 0;
...
const getExtractor = async () => {
    ...
    extractor = await (0, transformers_1.pipeline)('image-feature-extraction', 'Xenova/clip-vit-base-patch32', { dtype: 'fp32' });
    extractorReady = true;
 ...
 */
const getImageEmbedding = async (imageBuffer, mimeType) => {
    ...
    const tmpPath = path_1.default.join(os_1.default.tmpdir(), `clip_img_${Date.now()}${ext}`);
    fs_1.default.writeFileSync(tmpPath, imageBuffer);
    try {
        const image = await transformers_1.RawImage.fromURL(tmpPath);
