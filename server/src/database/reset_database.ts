...
async function reset() {
    ...
    try {
        ...
        await db.execute('CREATE TABLE role_table (id INT AUTO_INCREMENT PRIMARY KEY, role_name VARCHAR(50) NOT NULL UNIQUE)');
        await db.execute("INSERT INTO role_table (role_name) VALUES ('admin'), ('farmer'), ('buyer'), ('brgy_official')");
